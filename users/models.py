...
class User(AbstractUser):
    ...
    #username
    #password
    designation = models.CharField('''choices''',max_length=32,db_index=True)
    ...
    #locality
    #city
    gender = models.CharField('''choices''',null=False)
    ...
    marital_status = models.CharField('''choices''',max_length=16,null=True)
    no_of_children = models.IntegerField(null = True)
    #groups
    blood_group = models.CharField('''choices''',max_length=12, null=True)
...
class UserExperience(BaseModel):
    ...
    skills = models.CharField(max_length=512, default= None, null=True)
    achievements = models.CharField(max_length= 512, default = None,null=True)
...
class UserGroup(BaseModel):
    ...
    def save(self,*args,**kwargs):
       ...
       # get or create group with name, returns tuple(object,true/false)
